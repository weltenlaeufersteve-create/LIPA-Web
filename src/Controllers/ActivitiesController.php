...
use App\Models\Activity; // audit log (distinct from ActivityItem)

// NOTE: named ActivitiesController (plural) to avoid colliding with the
// audit-log ActivityController. Handles the /activities resource (ActivityItem).
